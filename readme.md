...
`nopm install gulp gulp-concat gulp-rename gulp-uglify gulp-sass gulp-minify-css browser-sync gulp-imagemin gulp-changed gulp-minify-html gulp-notify gulp-clean streamqueue --save-dev`
